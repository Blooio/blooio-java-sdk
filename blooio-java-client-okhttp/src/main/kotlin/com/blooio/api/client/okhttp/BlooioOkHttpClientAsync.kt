...
package com.blooio.api.client.okhttp
...
/**
 * A class that allows building an instance of [BlooioClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class BlooioOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [BlooioClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): BlooioClientAsync = builder().fromEnv().build()
    }

    /** A builder for [BlooioOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.blooio.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [BlooioClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BlooioClientAsync =
            BlooioClientAsyncImpl(
                clientOptions
                    .httpClient(
