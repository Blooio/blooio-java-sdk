...
/**
 * A class that allows building an instance of [BlooioClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class BlooioOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [BlooioClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): BlooioClient = builder().fromEnv().build()
    }

    /** A builder for [BlooioOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BlooioClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BlooioClient =
            BlooioClientImpl(
                clientOptions
                    .httpClient(
