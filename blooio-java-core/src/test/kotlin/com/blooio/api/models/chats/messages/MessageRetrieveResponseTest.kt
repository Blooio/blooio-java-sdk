    ...
    fun create() {
        val messageRetrieveResponse =
            MessageRetrieveResponse.builder()
                ...
                .replyTo(
                    MessageRetrieveResponse.ReplyTo.builder()
                        .guid("guid")
                        .messageId("message_id")
                        .partIndex(0L)
                        .build()
        ...
        assertThat(messageRetrieveResponse.formattedText()).contains("formatted_text")
        ...
        assertThat(messageRetrieveResponse.replyTo())
            .contains(
                MessageRetrieveResponse.ReplyTo.builder()
                    .guid("guid")
                    .messageId("message_id")
