...
import com.blooio.api.client.okhttp.OkHttpClient
import com.blooio.api.core.RequestOptions
import com.blooio.api.core.Sleeper
import com.blooio.api.errors.BlooioRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw BlooioRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            BlooioRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
