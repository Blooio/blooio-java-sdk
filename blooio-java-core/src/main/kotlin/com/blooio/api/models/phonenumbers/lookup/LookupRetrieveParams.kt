 ...
 * entries.
 *
 * **Requires an Enterprise plan** (Dedicated Enterprise). Returns 403 if your organization does not
 * have an active enterprise subscription.
 */
...
private constructor(
    ...
    /**
     * Phone number to look up. Can be E.164 format (+12125551234), national format (2125551234), or
     * with formatting ((212) 555-1234).
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lookupRetrieveParams: LookupRetrieveParams) = apply {
            number = lookupRetrieveParams.number
    ...
    override fun toString() =
        "LookupRetrieveParams{number=$number, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
