...
private constructor(
    ...
    private val firstMessageTime: JsonField<Long>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        firstMessageTime: JsonField<Long> = JsonMissing.of(),
        ...
        @JsonProperty("is_group") @ExcludeMissing isGroup: JsonField<Boolean> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun firstMessageTime(): Optional<Long> = firstMessageTime.getOptional("first_message_time")
    ...
    /**
     * Returns the raw JSON value of [firstMessageTime].
     *
     * Unlike [firstMessageTime], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("first_message_time")
    @ExcludeMissing
    fun _firstMessageTime(): JsonField<Long> = firstMessageTime
     ...
     *
     * Unlike [inboundCount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("inbound_count")
    @ExcludeMissing
     ...
     *
     * Unlike [lastInboundTime], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("last_inbound_time")
    @ExcludeMissing
     ...
     *
     * Unlike [outboundCount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("outbound_count")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        private var firstMessageTime: JsonField<Long> = JsonMissing.of()
        ...
        internal fun from(chatRetrieveResponse: ChatRetrieveResponse) = apply {
            id = chatRetrieveResponse.id
            backgroundId = chatRetrieveResponse.backgroundId
            backgroundUrl = chatRetrieveResponse.backgroundUrl
            contact = chatRetrieveResponse.contact
            firstMessageTime = chatRetrieveResponse.firstMessageTime
            groupId = chatRetrieveResponse.groupId
            groupName = chatRetrieveResponse.groupName
            inboundCount = chatRetrieveResponse.inboundCount
            isGroup = chatRetrieveResponse.isGroup
            lastInboundTime = chatRetrieveResponse.lastInboundTime
            lastMessage = chatRetrieveResponse.lastMessage
            lastMessageTime = chatRetrieveResponse.lastMessageTime
            lastOutboundTime = chatRetrieveResponse.lastOutboundTime
            memberCount = chatRetrieveResponse.memberCount
            messageCount = chatRetrieveResponse.messageCount
            outboundCount = chatRetrieveResponse.outboundCount
            type = chatRetrieveResponse.type
        ...
        fun firstMessageTime(firstMessageTime: Long) =
            firstMessageTime(JsonField.of(firstMessageTime))

        /**
         * Sets [Builder.firstMessageTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.firstMessageTime] with a well-typed [Long] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun firstMessageTime(firstMessageTime: JsonField<Long>) = apply {
         ...
         *
         * You should usually call [Builder.inboundCount] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun inboundCount(inboundCount: JsonField<Long>) = apply { this.inboundCount = inboundCount }
         ...
         *
         * You should usually call [Builder.isGroup] with a well-typed [Boolean] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.lastInboundTime] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        fun lastMessageTime(lastMessageTime: Long) = lastMessageTime(JsonField.of(lastMessageTime))
         ...
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun lastOutboundTime(lastOutboundTime: Long) = lastOutboundTime(lastOutboundTime as Long?)
         ...
         *
         * You should usually call [Builder.outboundCount] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (firstMessageTime.asKnown().isPresent) 1 else 0) +
