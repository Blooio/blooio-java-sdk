...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookDeleteResponse: WebhookDeleteResponse) = apply {
            message = webhookDeleteResponse.message
            success = webhookDeleteResponse.success
        ...
        fun build(): WebhookDeleteResponse =
            WebhookDeleteResponse(message, success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "WebhookDeleteResponse{message=$message, success=$success, additionalProperties=$additionalProperties}"
}
