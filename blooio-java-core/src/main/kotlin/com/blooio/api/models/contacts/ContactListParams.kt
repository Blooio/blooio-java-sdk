...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contactListParams: ContactListParams) = apply {
            ...
            offset = contactListParams.offset
            q = contactListParams.q
            sort = contactListParams.sort
    ...
    override fun toString() =
        "ContactListParams{limit=$limit, offset=$offset, q=$q, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
