...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): WebhookRetrieveParams =
            WebhookRetrieveParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "WebhookRetrieveParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
