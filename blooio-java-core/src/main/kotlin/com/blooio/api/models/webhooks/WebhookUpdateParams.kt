...
private constructor(
     ...
     */
    fun deprecate(): Optional<Boolean> = body.deprecate()
    ...
    /**
     * Returns the raw JSON value of [deprecate].
     *
     * Unlike [deprecate], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _deprecate(): JsonField<Boolean> = body._deprecate()
    ...
    class Builder internal constructor() {
        ...
        /** Set to true to deprecate, false to undeprecate */
        fun deprecate(deprecate: Boolean) = apply { body.deprecate(deprecate) }

        /**
         * Sets [Builder.deprecate] to an arbitrary JSON value.
         *
         * You should usually call [Builder.deprecate] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun deprecate(deprecate: JsonField<Boolean>) = apply { body.deprecate(deprecate) }
    ...
    private constructor(
        private val deprecate: JsonField<Boolean>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            deprecate: JsonField<Boolean> = JsonMissing.of(),
        ...
        ) : this(deprecate, validUntil, webhookType, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun deprecate(): Optional<Boolean> = deprecate.getOptional("deprecate")
         ...
         * Unlike [deprecate], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("deprecate") @ExcludeMissing fun _deprecate(): JsonField<Boolean> = deprecate
        ...
        class Builder internal constructor() {
            ...
            private var deprecate: JsonField<Boolean> = JsonMissing.of()
            ...
            /** Set to true to deprecate, false to undeprecate */
            fun deprecate(deprecate: Boolean) = deprecate(JsonField.of(deprecate))

            /**
             * Sets [Builder.deprecate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.deprecate] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun deprecate(deprecate: JsonField<Boolean>) = apply { this.deprecate = deprecate }
             ...
             */
            fun build(): Body =
                Body(deprecate, validUntil, webhookType, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (deprecate.asKnown().isPresent) 1 else 0) +
        ...
        private val hashCode: Int by lazy {
            Objects.hash(deprecate, validUntil, webhookType, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{deprecate=$deprecate, validUntil=$validUntil, webhookType=$webhookType, additionalProperties=$additionalProperties}"
    }
