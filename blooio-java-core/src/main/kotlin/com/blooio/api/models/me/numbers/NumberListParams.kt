...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): NumberListParams =
            NumberListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "NumberListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
