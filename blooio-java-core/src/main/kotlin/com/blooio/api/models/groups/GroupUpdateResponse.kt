...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(groupUpdateResponse: GroupUpdateResponse) = apply {
            chatGuid = groupUpdateResponse.chatGuid
            createdAt = groupUpdateResponse.createdAt
            groupId = groupUpdateResponse.groupId
            iconUrl = groupUpdateResponse.iconUrl
            lastMessageDirection = groupUpdateResponse.lastMessageDirection
            lastMessageText = groupUpdateResponse.lastMessageText
            lastMessageTime = groupUpdateResponse.lastMessageTime
            memberCount = groupUpdateResponse.memberCount
            messageCount = groupUpdateResponse.messageCount
            name = groupUpdateResponse.name
            deviceSync = groupUpdateResponse.deviceSync
    ...
    private constructor(
        ...
        ) : this(action, chatGuid, error, synced, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            fun build(): DeviceSync =
                DeviceSync(action, chatGuid, error, synced, additionalProperties.toMutableMap())
        }
        ...
        class Action @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val ADD_PARTICIPANT = of("add_participant")

                @JvmField val REMOVE_PARTICIPANT = of("remove_participant")
            ...
            fun value(): Value =
                when (this) {
                    ADD_PARTICIPANT -> Value.ADD_PARTICIPANT
                    REMOVE_PARTICIPANT -> Value.REMOVE_PARTICIPANT
                    LEAVE -> Value.LEAVE
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    ADD_PARTICIPANT -> Known.ADD_PARTICIPANT
                    REMOVE_PARTICIPANT -> Known.REMOVE_PARTICIPANT
                    LEAVE -> Known.LEAVE
        ...
        private val hashCode: Int by lazy {
            Objects.hash(action, chatGuid, error, synced, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "DeviceSync{action=$action, chatGuid=$chatGuid, error=$error, synced=$synced, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "GroupUpdateResponse{chatGuid=$chatGuid, createdAt=$createdAt, groupId=$groupId, iconUrl=$iconUrl, lastMessageDirection=$lastMessageDirection, lastMessageText=$lastMessageText, lastMessageTime=$lastMessageTime, memberCount=$memberCount, messageCount=$messageCount, name=$name, deviceSync=$deviceSync, additionalProperties=$additionalProperties}"
}
