...
/**
 * Look up multiple phone numbers in a single request. Returns the same detailed information as the
 * single lookup endpoint for each number. Maximum 100 numbers per request.
 *
 * **Requires an Enterprise plan** (Dedicated Enterprise).
 */
class PhoneNumberBatchCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneNumberBatchCreateParams].
         *
    ...
    /** A builder for [PhoneNumberBatchCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneNumberBatchCreateParams: PhoneNumberBatchCreateParams) = apply {
            body = phoneNumberBatchCreateParams.body.toBuilder()
            additionalHeaders = phoneNumberBatchCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = phoneNumberBatchCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneNumberBatchCreateParams].
         *
         ...
         */
        fun build(): PhoneNumberBatchCreateParams =
    ...
    private constructor(
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (numbers.asKnown().getOrNull()?.size ?: 0)
        ...
        override fun toString() =
            "Body{numbers=$numbers, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneNumberBatchCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PhoneNumberBatchCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
