...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): WebhookUpdateResponse =
            WebhookUpdateResponse(message, status, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "WebhookUpdateResponse{message=$message, status=$status, additionalProperties=$additionalProperties}"
}
