 ...
 * updated in the linked iMessage chat. Note: iMessage only allows one chat per unique participant
 * set, so renaming simply changes the display name on the existing chat thread.
 */
