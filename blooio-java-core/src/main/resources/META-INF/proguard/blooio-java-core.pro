...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.blooio.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.blooio.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.blooio.api.** {
    <init>(...);
