...
dependencies {
    testImplementation(project(":blooio-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../blooio-java-core/src/main/resources/META-INF/proguard/blooio-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.blooio.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../blooio-java-core/src/main/resources/META-INF/proguard/blooio-java-core.pro",
